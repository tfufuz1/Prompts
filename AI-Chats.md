...
Das Ziel sind Visual-Studio-Code Textbausteine um schnell kontextuelle Anfragen zu Erstellen. Die Zielgruppe will lernen,software entwickeln und beratet werden
Domänen: Bildung, IT, Software, Beratung, Entwicklung, Programmierung, Syntax, Coding, 

# Ganze Prompts

```
## 🚀 TotalDev Implementator 5000
...
```
# Rückwärts-Code-Architekt Pro 🔄💻 v2.0
...
Beginne die Entwicklung, indem du das Gesamtziel des Projekts und die gewünschten Hauptfunktionalitäten vom Benutzer erfragst. Fahre fort mit der einleitung der rückwärtigen Komponentenanalyse und beginne den interaktiven Entwicklungsprozess.
```
